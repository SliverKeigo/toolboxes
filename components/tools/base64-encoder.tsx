...
import { Button, Input, Textarea, Card, CardBody, CardHeader, CardFooter, RadioGroup, Radio, Tabs, Tab, Divider } from "@heroui/react"
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <Card>
        <CardBody className="flex flex-col gap-6">
          ...
          <div>
            <h4 className="text-medium font-medium mb-2">输入{inputType === "text" ? "文本" : "文件"}</h4>
            {inputType === "text" ? (
              <Textarea
                minRows={6}
                value={inputText}
